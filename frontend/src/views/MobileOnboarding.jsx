...
// everything on this device, or connect to a self-hosted Barbell server instead. See
...
export default function MobileOnboarding() {
  ...
  return (
    <div className="narrow" style={wrap}>
      {head}
      <div className="muted" style={{ marginBottom: 34 }}>{t('How do you want to use Barbell?')}</div>
      ...
      <div className="dim small" style={{ marginTop: 26, lineHeight: 1.5 }}>
        {t('Local keeps everything on this phone. Connecting syncs to your own Barbell server instead — you can switch later in Settings.')}
      </div>
    </div>
  )
}
